 ...
 * Раскладка 1:1 с MyProfileClient + editorial UI (no gradients,
 * rounded-2xl ring-border cards).
 */
...
/**
 * Компактный skeleton для секции образования/работы (inline).
 */
export function EducationSkeleton() {
  return (
    <div className="space-y-3">
      {[1, 2].map((i) => (
        <div key={i} className="p-4 bg-muted/30 rounded-xl animate-pulse space-y-2">
