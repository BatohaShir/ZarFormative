          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-9 h-9 rounded-full bg-linear-to-br from-purple-500 via-pink-500 to-orange-400 flex items-center justify-center text-white hover:opacity-80 transition-opacity"
              >
