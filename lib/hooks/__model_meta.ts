...
const metadata: ModelMeta = {
  models: {
    ...
    profiles_push_subscriptions: {
      name: "profiles_push_subscriptions",
      fields: {
        id: {
          name: "id",
          type: "String",
    ...
    profiles_notification_settings: {
      name: "profiles_notification_settings",
      fields: {
        id: {
          name: "id",
          type: "String",
    ...
    profiles_work_experiences: {
      name: "profiles_work_experiences",
      fields: {
        id: {
          name: "id",
          type: "String",
    ...
    ad_stories: {
      ...
      fields: {
        ...
        plan: {
          name: "plan",
          type: "String",
          attributes: [{ name: "@default", args: [{ name: "value", value: "1day" }] }],
        },
        status: {
          name: "status",
          type: "AdStoryStatus",
    ...
    listing_boosts: {
      ...
      fields: {
        ...
        plan: {
          name: "plan",
          type: "String",
          attributes: [{ name: "@default", args: [{ name: "value", value: "3day" }] }],
        },
        status: {
          name: "status",
          type: "BoostStatus",
